package com.buaa.sys.auditLog.dao;
...
public class AuditLogDao extends HibernateBaseDao{
	...
	public void queryAuditLog(Page<AuditLog> page, Map<String, Object> parameter,Criteria criteria) throws Exception {
        ...
        StringBuffer coreHql = new StringBuffer("from " + AuditLog.class.getName()+" a where 1=1 ");
        
        if (null != parameter && !parameter.isEmpty()) {
			String operationType = (String) parameter.get("operationType");
			int a;
			if (StringUtils.isNotEmpty(operationType)) {
				coreHql.append(" and a.operationType = :ot ");
	 ...
	 * @throws Exception
	 */
	public void saveData(AuditLog detail) throws Exception {
	...
	public Integer conlumIdentity() {
		String hql = "select count(*) from " + AuditLog.class.getName()
				+ " u where 1=1";
	 ...
	 * @throws Exception
	 */
	public void updateData(AuditLog detail) throws Exception {
		Session session = this.getSessionFactory().openSession();
		try {
	 ...
	 * @throws Exception
	 */
	public void deleteData(AuditLog detail) throws Exception {
		Session session = this.getSessionFactory().openSession();
		try {
