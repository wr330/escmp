	...
	*/
	 ...
	 */
	 ...
	 public void saveCombineVehicle(Map<String, Collection> dataItems) throws Exception {
	    Collection<CombineVehicle> details =(Collection<CombineVehicle>) dataItems.get("dsCombineVehicle");
	 ...
	 * @throws Exception
	 */
	 public void saveCombineVehicle(Collection<CombineVehicle> details) throws Exception {
		if (null != details && details.size() > 0) {
	    	for(CombineVehicle item : details) {
				...
				if (state.equals(EntityState.NEW)) {
					...
					EntityState outlineExecutionState = EntityUtils.getState(item.getOutlineExecution());
