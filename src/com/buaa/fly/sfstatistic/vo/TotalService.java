...
public class TotalService extends HibernateBaseDao {
	 ...
	 */
	@DataProvider
	public Total loadTotal(Map<String, Object> parameter) throws Exception {
	...
	public Collection<MonthTotal> loadMonthTotal(Map<String, Object> parameter) {
		...
		for (int month = 1; month <= 12; month++) {
			String coreHql = hql + " and a.fdate>='" + thisyear + "-" + month
					+ "-1 00:00:00' and a.fdate<'"
					+ (month == 12 ? thisyear + 1 : thisyear) + "-"
					+ (month == 12 ? 1 : month + 1) + "-1 00:00:00'";
